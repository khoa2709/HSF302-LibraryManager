...
public class DataInitializer {
    ...
    CommandLineRunner initData(UserService userService, CategoryService categoryService, BookService bookService, LoanService loanService) {
        return args -> {
            // 1. Users
                User nttv = new User("Nguyễn Thị Tường Vy", "admin", "123", "admin");
                User ndk = new User("Nguyễn Đăng Khoa", "staff", "123", "staff");
                User nlv = new User("Nguyễn Ly Vi", "member1", "123", "member");
                User nht = new User("Nguyễn Hữu Thành", "member2", "123", "member");
                User nch = new User("Nguyễn Công Hậu", "member3", "123", "member");
                userService.saveAll(Arrays.asList(nttv,ndk,nlv,nht,nch));

            // 2. Categories
                Category c1 = new Category("Sách giáo khoa");
                Category c2 = new Category("Truyện thiếu nhi");
                Category c3 = new Category("Khoa học");
                Category c4 = new Category("Văn học");
                Category c5 = new Category("Lịch sử");
                categoryService.saveAll(Arrays.asList(c1, c2, c3, c4, c5));


            // 3. Books
                bookService.saveAll(Arrays.asList(
                    new Book("Toán lớp 5", "Nhiều tác giả", "NXB Giáo dục", 2021, c1, 10),
                    new Book("Ngữ Văn lớp 5", "Nhiều tác giả", "NXB Giáo dục", 2021, c1, 8),
                    new Book("Dế Mèn Phiêu Lưu Ký", "Tô Hoài", "NXB Kim Đồng", 2019, c2, 5),
                    new Book("Vũ trụ và các hành tinh", "Trần Minh", "NXB Khoa học", 2020, c3, 3),
                    new Book("Truyện cổ tích Việt Nam", "Tổng hợp", "NXB Trẻ", 2018, c2, 6),
                    new Book("Đại chiến thế giới I", "Lịch sử tổng hợp", "NXB Chính trị", 2017, c5, 2)
                ));
